        ...
        if (body.length > 0) {
            body.forEach(function (k) {
                tasks.push({
                    ...
                    status: (k.status.toString() === "READY") ? task_1.Status.Ready : (k.status.toString() === "INPROGRESS") ? task_1.Status.Inprogress : task_1.Status.Finished,
